...
function ProxyServer(options) {
  ...
  // Allow by default empty headers in websocket upgrade response
  // to avoid unexpexted behaviour.
  // Related to Safari bug 
  // https://bugs.webkit.org/show_bug.cgi?id=139298
  options.wsAllowEmptyResHeaders = options.wsAllowEmptyResHeaders === false ? false : true;
